...
const objects: any[] = [];
const targets = { table: [] as THREE.Object3D[], sphere: [] as THREE.Object3D[], helix: [] as THREE.Object3D[], grid: [] as THREE.Object3D[] };
...
<template>
  ...
  <div id="menu">
    <button ref="tableRef"
      @click="() => { transform(targets.table, 2000); }">TABLE</button>
    <button ref="sphereRef"
      @click="() => {transform(targets.sphere, 2000); }">SPHERE</button>
    <button ref="helixRef"
      @click="() => { transform(targets.helix, 2000); }">HELIX</button>
    <button ref="gridRef" @click="() => { transform(targets.grid, 2000); }">GRID</button>
  </div>
</template>
